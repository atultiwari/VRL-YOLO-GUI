...
- ⏳ **P6c next** — Polish + reconnect-with-backoff on WS drops + best.pt download resumability + the 9-step pilot test against real Colab in PLAN-P6.md §7. Target tag `v0.9-p6-train-colab` (matches PLAN.md §14's planned phase-completion tag).
